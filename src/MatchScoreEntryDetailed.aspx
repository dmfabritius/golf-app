<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MatchScoreEntryDetailed.aspx.cs" Inherits="Golf.MatchScoreEntryDetailed" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <asp:Panel ID="pnlSelPlayer" runat="server" Visible="True" CssClass="form-group"><asp:UpdatePanel ID="updddPlayers" runat="server"><ContentTemplate>
                <div class="row">
                    <div class="col-sm-4"><label class="control-label" for="ddPlayers">Select a player:</label></div>
                    <div class="col-sm-8"><asp:DropDownList ID="ddPlayers" runat="server" AutoPostBack="True" CssClass="form-control mini"
                        DataSourceID="sqlViewPlayerList" DataTextField="PlayerName" DataValueField="PlayerID" OnSelectedIndexChanged="ddPlayers_SelectedIndexChanged" OnDataBound="ddPlayers_DataBound"/></div>
                </div>
            </ContentTemplate></asp:UpdatePanel></asp:Panel>
        </div>
        <div class="col-sm-8">
    ...
    <asp:SqlDataSource ID="sqlViewPlayerList" runat="server" ConnectionString="<%$ ConnectionStrings:GolfDb %>"
        SelectCommand="MatchPlayers" SelectCommandType="StoredProcedure">
        <SelectParameters>
