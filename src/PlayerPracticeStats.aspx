<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PlayerPracticeStats.aspx.cs" Inherits="Golf.PlayerPracticeStats" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-sm-8">
            <h3>Player Practice Statistics</h3>
        </div>
    ...
    <asp:UpdatePanel ID="updPlayerStats" runat="server"><ContentTemplate>
        <asp:GridView ID="gvPlayerStats" runat="server" AutoGenerateColumns="False" DataSourceID="sqlPlayerStats" DataKeyNames="PlayerID"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Score" HeaderText="Score" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Center" SortExpression="Score, PlayerName ASC" />
                <asp:BoundField DataField="Points" HeaderText="Points" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Center" SortExpression="Points DESC, PlayerName ASC" />
    ...
    <asp:SqlDataSource ID="sqlPlayerStats" runat="server" ConnectionString="<%$ ConnectionStrings:GolfDb %>"
        SelectCommand="PlayerPracticeStats" SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:ControlParameter Name="StateID" ControlID="ddStates" PropertyName="SelectedValue" Type="Int32" />
            <asp:ControlParameter Name="DistrictID" ControlID="ddDistricts" PropertyName="SelectedValue" Type="Int32" />
            <asp:ControlParameter Name="LeagueID" ControlID="ddLeagues" PropertyName="SelectedValue" Type="Int32" />
            ...
            <asp:Parameter Name="IsPractice" Type="Int32" DefaultValue="1" />
        </SelectParameters>
    </asp:SqlDataSource>
